...
public class NodeEditor : Editor
{
    ...
    private void RandomizeColor(Node node)
    {
        SerializedObject serializedNode = new SerializedObject(node);
        SerializedProperty connectionColorProperty = serializedNode.FindProperty("connectionColor");

        Color newColor = Node.GetRandomColor();
        connectionColorProperty.colorValue = newColor;
