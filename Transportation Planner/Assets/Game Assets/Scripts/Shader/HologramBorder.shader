Shader "Custom/HologramBorder" {
	Properties {
		...
		_HoloRadius("Holo Radius", Range(0,100)) = 10
		[Space(10)]
	...
	SubShader {
		...
		void surf (Input IN, inout SurfaceOutput o) 
		{
			...
			float distanceToPlayer = distance(IN.worldPos, _WorldSpaceCameraPos);
			if (distanceToPlayer <= _HoloRadius)
			{
